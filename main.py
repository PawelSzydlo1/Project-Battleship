...
while True:
    ...
    button_main(SCREEN,(WIDTH-BUTTON_WIDTH)/2,(WIDTH-BUTTON_WIDTH)/2+BUTTON_WIDTH,450,575,BLUE,GREEN,quit)
    text("EXIT",FONT,(WIDTH-BUTTON_WIDTH)/2+BUTTON_WIDTH/2, 450+BUTTON_HEIGHT/2, BLACK)
